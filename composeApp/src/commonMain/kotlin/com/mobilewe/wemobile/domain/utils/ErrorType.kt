package com.mobilewe.wemobile.domain.utils
...
sealed class PayBillException(val errorMessage: String = ""): Exception(){
    data object InvalidAccountNumber: PayBillException()
    data object InvalidBusinessNumber: PayBillException()
